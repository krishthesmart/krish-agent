...
from tools import read_file, normalize_path
...
class AgentOrchestrator:
    ...
    def add_tests(self, target_path: str, review: bool = False, apply_corrections: bool = False) -> Dict:
        """
...
Examples:
  ...
  python cli.py add-tests src/ --review

  # Generate tests, review, and apply corrections
  python cli.py add-tests src/main.py --review --apply-corrections
